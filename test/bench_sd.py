...
用法:
  import bench_sd
  bench_sd.run()           # 完整測試矩陣（含 F1~F5）
  bench_sd.run_quick()     # 快速測試 (只測默認 buffer 的 F1~F3)
  bench_sd.run_dma()       # 只跑 F4: DMA vs bytearray 對比
  bench_sd.run_stream()    # 只跑 F5: StreamReader 預讀管線
"""
